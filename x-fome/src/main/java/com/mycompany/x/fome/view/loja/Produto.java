...
public class Produto extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tipoProduto.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        tipoProduto.setText("Tipo Produto");
        tipoProduto.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tipoProdutoMouseClicked(evt);
            }
        });
    ...
    private void tipoProdutoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tipoProdutoMouseClicked
        
    }//GEN-LAST:event_tipoProdutoMouseClicked
    
    public void setTipoProduto(String text){
        this.tipoProduto.setText(text);
    }
    /**
